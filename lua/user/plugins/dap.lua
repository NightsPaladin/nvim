return {
  -- Core DAP
  {
    ...
    keys = {
      ...
      { "<leader>dn", function() require("dap").step_over() end, desc = "[D]ebug: Step [N]ext (over)" },
      ...
      { "<leader>dk", function() require("dap").up() end, desc = "[D]ebug: Up Stack" },
      { "<leader>dj", function() require("dap").down() end, desc = "[D]ebug: Down Stack" },
    },
  },
}
